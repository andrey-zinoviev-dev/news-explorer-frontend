...
function SavedNews(props) {
    ...
    return (
        <>
       <SavedNewsHeader loggedIn={true} shortenedHeaderWidth={props.shortenedHeaderWidth}></SavedNewsHeader>
       <section className="saved-news">
           <div className="container">
               <div className='saved-news__wrapper'>
                    <p className="saved-news__subtitle">Сохраненные статьи</p>
                    <h2 className="saved-news__heading">{props.user.name}, у вас {props.savedNews.length} сохраненных {props.savedNews.length > 0 && props.savedNews.length<5 ? "статьи" : "статей"}</h2>
