...
function Header (props) {
    ...
    return (
        ...
        <header className={props.mainPage ? `header ${clickedMenuLogo ? "header_type_authorization_status_active" : ""}` : "header header_type_saved-news"}>
            <div className="container">
                <div className="header__wrapper">
                    <Link to="/" className="header__link_status_active"><span className={props.mainPage ? "header__title-span" : "header__title-span header__title-span_type_saved-news"}>NewsExplorer</span></Link>
                    {props.shortenedHeaderWidth ? <img src={props.mainPage ? menuLogo : menuLogoBlack} onClick={showMenuOnCLick}></img> : <nav className="header__menu">
                        {props.user ? <><Link to="/" className={props.mainPage ? "header__link header__link_status_active" : "header__link header__link_type_saved-news"}>Главная</Link><Link to="/saved-news" className={props.mainPage? "header__link" : "header__link header__link_type_saved-news header__link_type_saved-news_status_active"}>Сохраненные статьи</Link></> : <Link to="/" className="header__link header__link_status_active">Главная</Link>}
        ...
        {props.user ? <><Link to="/" className={props.mainPage && clickedMenuLogo? "header__link header__link_type_small-header" : "header__link header__link_type_saved-news"}>Главная</Link><Link to="/saved-news" className={props.mainPage? "header__link" : "header__link header__link_type_saved-news header__link_status_inactive"}>Сохраненные статьи</Link></> : <Link to="/" className="header__link header__link_status_active header__link_status_inactive">Главная</Link>}
